import project1 from "../assets/projects/NaN.png";
...
export const S_HERO_CONTENT = `I am a passionate basketball player with extensive experience representing my university and achieving excellence in the sport. As a Division 'A' player and vice captain, I have honed my leadership, teamwork, and strategic thinking skills. My accolades include multiple University Sports Colors awards, the prestigious Best Player Award (2023), and recognition at national-level competitions like SLUSA (2022). My dedication to basketball reflects my ability to perform under pressure, collaborate effectively, and lead teams to success. These experiences have shaped my discipline, resilience, and drive to achieve excellence both on and off the court.`;
...
export const S_ABOUT_TEXT = `I am a passionate basketball player with a strong track record in sports at university, district, and provincial levels. Starting my journey in mid-2011, I have secured multiple provincial-level championships and won a Division C Under-19 championship. I served as the Sports Vice Captain of my college and Vice Captain of my college basketball team, demonstrating early leadership qualities. Currently, I play for my district and provincial teams. As the Vice Captain of the University of Colombo basketball team, I have continued to showcase leadership, teamwork, and strategic thinking. My achievements include receiving the Best Player Award in 2023, earning University Sports Colors in 2022 and 2023, and representing Sri Lanka at the university level with SLUSA Sports Colors in 2022. These experiences have honed my ability to perform under pressure, collaborate with diverse teams, and excel in both competitive and supportive roles.`;
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project3,
    description:
      "A fully functional library management website with features like book listing, book resevation,  and user authentication.",
